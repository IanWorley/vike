...
async function onClick(ev: MouseEvent) {
  ...
  // Workaround for Firefox bug: clicking on a hash link that doesn't change the url causes Firefox to erroneously set `window.history.state = null` without firing any signal that we can detect.
