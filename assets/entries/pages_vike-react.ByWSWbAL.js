import{j as e,L as t,o as l,i as a}from"../chunks/chunk-BcpqjoRF.js";import{L as s}from"../chunks/chunk-DdfiwLvj.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as d}from"../chunks/chunk-6HWZdrMJ.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DKWR41nL.js";/* empty css                      *//* empty css                      */const c=[{pageSectionId:"scaffold-new-vike-react-app",pageSectionLevel:2,pageSectionTitle:"Scaffold new `vike-react` app"},{pageSectionId:"add-vike-react-to-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-react` to existing Vike app"},{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(r){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(s,{href:"/extensions",children:"Vike extension"})," ",e.jsx(n.code,{children:"vike-react"})," integrates ",e.jsx(n.a,{href:"https://react.dev",children:"React"})," in a full-fledged manner, providing a DX like a regular frontend framework like Next.js and Remix."]}),`
