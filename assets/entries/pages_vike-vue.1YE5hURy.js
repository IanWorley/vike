import{j as e,L as l,o as t,i as d}from"../chunks/chunk-BcpqjoRF.js";import{L as s}from"../chunks/chunk-DdfiwLvj.js";/* empty css                      *//* empty css                      *//* empty css                      */import{U as o}from"../chunks/chunk-6HWZdrMJ.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DKWR41nL.js";/* empty css                      *//* empty css                      */const a=[{pageSectionId:"scaffold-new-vike-vue-app",pageSectionLevel:2,pageSectionTitle:"Scaffold new `vike-vue` app"},{pageSectionId:"add-vike-vue-to-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-vue` to existing Vike app"},{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(i){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(s,{href:"/extensions",children:"Vike extension"})," ",e.jsx(n.code,{children:"vike-vue"})," integrates ",e.jsx(n.a,{href:"https://vuejs.org",children:"Vue"})," in a full-fledged manner, providing a DX like a regular frontend framework such as Nuxt."]}),`
