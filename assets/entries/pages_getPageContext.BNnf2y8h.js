import{j as e,L as o,o as t,i}from"../chunks/chunk-BcpqjoRF.js";import{L as s}from"../chunks/chunk-DdfiwLvj.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DKWR41nL.js";/* empty css                      *//* empty css                      */const r=[{pageSectionId:"universal-hooks",pageSectionLevel:2,pageSectionTitle:"Universal Hooks"},{pageSectionId:"example",pageSectionLevel:2,pageSectionTitle:"Example"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"getPageContext()"})," function allows you to access the ",e.jsxs(s,{href:"/pageContext",children:[e.jsx(n.code,{children:"pageContext"})," object"]})," inside Vike hooks."]}),`
